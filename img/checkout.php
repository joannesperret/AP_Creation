                              ...
                              <div class="row" class="checkout__input__checkbox" id=civilite>                                                      
                                <div class="col-lg-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="civilite" value="Madame" checked="<?php if (isSet($_SESSION['nom'])==="Madame") echo "checked" ?>" >
                                ...
                                <div class="col-lg-9">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="civilite" value="Monsieur" checked="<?php if (isSet($_SESSION['nom'])==="Monsieur") echo "checked" ?>" >
                        ...
                        <!--AJAX à installer sur Ville et code postal-->
                             <div class="row">                                
                                <div class="col-lg-6">
                                    <div class="checkout__input">
<!--                                        <p>Ville</p>-->
<!--                                        <input id="" type="text" name="villeInscription" placeholder="ville" value="<?php if (isSet($_SESSION['ville'])) echo $_SESSION['ville']?>">-->
                                        <p>Sélectionnez votre ville<span>*</span></p>
                                        <p id="pResultat" class="checkout_input"></p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
...
<!--                                        <input type="text" name="cpInscription" placeholder="Code Postal" value="<?php if (isSet($_SESSION['cp'])) echo $_SESSION['cp']?>">-->
                        ...
                        <!--AJAX à installer sur Ville et code postal-->
                            ...
                            <p>Si vous êtes déjà inscrit, connectez- vous en haut de page.</p>
                            <div class="checkout__input">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Créer un compte?
                                        <input type="checkbox" id="acc-or" name="inscription" value="inscription">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
